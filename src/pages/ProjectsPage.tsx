  ...
  const projects = [
    {
      ...
      github: 'https://github.com/tuannt/ecommerce-platform',
    ...
    },
    {
      ...
      description: t('projects.microservices.desc'),
      image: 'https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800',
      technologies: ['Java', 'Spring Cloud', 'MongoDB', 'RabbitMQ', 'Docker'],
      github: 'https://github.com/tuannt/microservices-architecture',
      demo: 'https://microservices-demo.tuannt.me',
      featured: true,
    ...
    },
    {
      ...
      github: 'https://github.com/tuannt/rest-api-framework',
    ...
    },
    {
      ...
      github: 'https://github.com/tuannt/quiz-application',
      demo: '/quiz',
      featured: false,
      status: t('projects.status.completed'),
      team: '1 developer',
    ...
    },
    {
      ...
      description: t('projects.monitoring.desc'),
      image: 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=800',
      technologies: ['Java', 'Spring Boot', 'Prometheus', 'Grafana', 'ELK Stack'],
      github: 'https://github.com/tuannt/monitoring-system',
      demo: 'https://monitoring.tuannt.me',
      featured: false,
      status: t('projects.status.production'),
      team: '4 developers',
      duration: '5 months',
    },
    {
      ...
      technologies: ['Java', 'Spring Boot', 'NLP', 'WebSocket', 'PostgreSQL'],
      github: 'https://github.com/tuannt/ai-chatbot',
      demo: 'https://chatbot-demo.tuannt.me',
      featured: false,
      status: t('projects.status.development'),
      team: '3 developers',
      duration: '7 months',
